...
//  XinstallRNConfig.m
//  RNXinstall
//  Xinstall ReactNative 模块配置文件
//  Created by Xinstall on 2021/5/17.
...
NSString *const XinstallThirdVersionFlag = @"XINSTALL_THIRDSDKVERSION_1.2.5_THIRDSDKVERSION_XINSTALL";

NSInteger const XinstallThirdPlatform = 9;
NSString *const XinstallThirdVersion = @"1.2.5";
